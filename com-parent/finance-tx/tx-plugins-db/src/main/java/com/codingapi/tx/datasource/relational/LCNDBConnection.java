...
public class LCNDBConnection extends AbstractTransactionThread implements LCNConnection {
    ...
    public void transaction() throws SQLException {
        ...
        ScheduledExecutorService executorService = new ScheduledThreadPoolExecutor(1,
                new BasicThreadFactory.Builder().namingPattern("tx-transaction-thread-pool-%d").daemon(true).build());
        ...
        logger.info("LCN connection autoCommit state:{}",connection.getAutoCommit());
    ...
    public void setAutoCommit(boolean autoCommit) throws SQLException {
        ...
        if(connection!=null) {
            logger.info("lcn connection set autoCommit false");
