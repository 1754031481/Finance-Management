...
import com.zc.dao.permission.*;
import com.zc.constants.permission.RoleIDEnum;
import com.zc.dto.permission.RoleDTO;
import com.zc.dto.permission.RoleMenuDTO;
import com.zc.service.permission.IRoleService;
...
public class RoleTServiceImpl implements IRoleService {
	...
	@Override
	public HashMap<String,Object> getRoleListByPage(PageBean page,RoleDTO role) {
	...
	public Result getRoleList() {
		Result result =new Result();
		result.setCode(200);
		result.setContent( roleMapper.getAllRole());
		return result;
    }
    ...
    public Result getRoleMenuAndMenuBtnByRoleId(Long roleId) {
		...
		Result result =new Result();
		result.setCode(200);
		result.setContent( paramsTrans(insertBtn(list, roleId), menuIds));
		return result;
	}
