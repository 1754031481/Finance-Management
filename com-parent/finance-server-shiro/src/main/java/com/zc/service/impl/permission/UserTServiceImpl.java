...
import com.zc.dto.permission.UpdatePassDTO;
import com.zc.dto.permission.UpdateUserRoleDTO;
import com.zc.dto.permission.UserDTO;
import com.zc.dto.permission.UserRoleDTO;
import com.zc.entity.permission.Role;
import com.zc.entity.permission.User;
import com.zc.entity.permission.UserRole;
import com.zc.exception.permission.PermissionBizException;
...
public class UserTServiceImpl implements IUserService {
    ...
    public Result addUser(UserRoleDTO dto) {
        try {
        	...
        	//if (ParamsCheck.checkAddUser(dto)) {
                ...
                result.setCode(200);
                result.setMsg(PermissionEnum.Code.SUCCESS.getMsg());
    ...
    public Result updatePass(UpdatePassDTO updatePassDto) {
        try {
            ...
            if (user != null && StringUtils.isNotBlank(user.getPassword())
                ...
                result.setMsg(PermissionEnum.PASSWORD_ERROR.getMsg());
            }
    ...
    @Override
    public HashMap<String,Object> getUserListByPage(PageBean page, UserDTO userDto) {
    ...
    public Result getUserRoleByUserId(Long userId) {
        ...
        result.setCode(200);
        result.setMsg("操作成功");
        result.setContent(userRoleMapper.selectUserRoleByUserId(userId));
        return result;
    }
        ...
        if (userVO == null) {
         ...
         if (userVO.getIsable().equals(b)) {
            ...
            if (userVO.getAgentName() != null) {
                ...
                result.setCode(10023);
                result.setMsg( "后台管理员没有忘记密码操作");
                return result;
            }
        }
    }
