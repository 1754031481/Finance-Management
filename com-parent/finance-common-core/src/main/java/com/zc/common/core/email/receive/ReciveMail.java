...
public class ReciveMail {
	...
	public void getMailContent(Part part) throws MessagingException, IOException {
		...
		String testp = "text/plain";
		String testh = "text/html";
		String multipartp = "multipart/*";
		String messager = "message/rfc822";
		if (part.isMimeType(testp) && !conname) {
			bodytext.append((String) part.getContent());
		} else if (part.isMimeType(testh) && !conname) {
			bodytext.append((String) part.getContent());
		} else if (part.isMimeType(multipartp)) {
			Multipart multipart = (Multipart) part.getContent();
			int count = multipart.getCount();
			for (int i = 0; i < count; i++) {
				getMailContent(multipart.getBodyPart(i));
			}
		} else if (part.isMimeType(messager)) {
	...
	public void saveAttchMent(String baseFile, Part part) throws MessagingException, IOException {
		...
		String fileName = "";
		String mu = "multipart/*";
		String mef = "message/rfc822";
		if (part.isMimeType(mu)) {
