package com.zc.common.core.oss;
...
//		Random r = new Random();
//		String realPath = ServerParam.BASE_PATH;//实际路径
...
//					appResult.setError_info(imageName + "上传的文件不能大于30M");
//				} else {
...
////					alyUpload(module,newFileName,realPath+img_url,InitParam.getInitParam());
//					alyUpload(module,newFileName,realPath+img_url,null);
...
//				alyUpload(module,sysFileName,path,InitParam.getInitParam());
...
//	}
	 ...
	 * @param path 路劲
	 */
//	public static void alyUpload(String module,String sysFileName,String path,InitParam initParam)
	public static void alyUpload(String module,String sysFileName,String path,String a)
	{
...
//		OSS_IS_OPEN=true
//		OSS_ACCESS_ID=e6wt7YMUZEru6TOD
//		OSS_ACCESS_KEY=QLhDKpV0Rez9fsH6oIOXbmks4sd7WE
//		OSS_BUCKET_NAME=yst-images
		String isOpen="true";
